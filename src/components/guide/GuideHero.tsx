...
export default function GuideHero() {
  ...
  return (
    <section data-zone="dark" className="relative min-h-[92svh] flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative max-w-content mx-auto w-full px-6 md:px-10 pb-10 md:pb-14 pt-24 md:pt-40">
        <RevealOnScroll>
          ...
          <div className="no-print mt-6 md:mt-8 flex flex-wrap gap-3">
        ...
        {/* Info cards */}
        <RevealOnScroll variant="stagger-parent" className="mt-6 md:mt-10 grid gap-2 md:gap-3 sm:grid-cols-3">
          {[
            ...
            <RevealOnScroll variant="stagger-child" key={c.label}>
              <div className="guide-card h-full rounded-2xl border border-linen/20 bg-night/25 p-4 md:p-5" style={{ backdropFilter: 'blur(8px)' }}>
                ...
                {c.support && (
                  <div className="no-print mt-2 md:mt-3 flex gap-2">
                ...
                {c.lateCheckout && (
                  <div className="no-print mt-2 md:mt-3">
                    <a
